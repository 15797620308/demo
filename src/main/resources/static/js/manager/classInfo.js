    ...
    var
        ...
        infoOptions = {
            ...
            cols: [[
                ...
                {field: 'classid', title: 'ID', type:'checkbox', width:'10%', sort: true, fixed: 'left'}
                ,{field: 'classname', title: '名称', width:'15%',edit:'text'}
                ,{field: 'classtime', title: '开班时间', width:'15%'}
                ,{field: 'classmajor', title: '专业', width:'15%',edit:'text'}
                ,{field: 'classnum', title: '人数', width:'10%'}
                ,{field: 'teachname', title: '班导', width:'15%',templet: '<div>{{d.teacherInfo.teachname}}</div>'}
                         ...
                         if(deList!=''){
                                  layer.confirm('确定删除所选项吗？',function (index) {
                                          $.ajax({
                                                 ...
                                                 type:'post',
                                                  dataType:'json',
                                                 data:{arr:deList.toString(),object:"classInfo"},
            ...
            layer.open(
                {
                    ...
                    area: ['380px','485px'],
                    resize:true,
                    content: "/user/edit/EditClassInfo",//跳转的页面
    ...
    table.on('tool(test)', function(obj){
        ...
        } else//删除数据
        {
            layer.confirm('真的删除行么', function(index){
                $.post("/user/deldata",{id:data.classid,object:"classInfo" },
                function(msg){
                    if(msg.code==1){
