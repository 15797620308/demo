    ...
    var
        ...
        infoOptions = {
            ...
            cols: [[
                ...
                {field: 'courseid', title: 'ID', type:'checkbox', width:'20%', sort: true, fixed: 'left'}
                ,{field: 'coursename', title: '名称', width:'20%',edit:'text'}
                ,{field: 'coursetime', title: '课时(节)', width:'20%'}
                ,{field: 'grade', title: '年级', width:'20%',edit:'text'}
                         ...
                         if(deList!=''){
                                  layer.confirm('确定删除所选项吗？',function (index) {
                                          $.ajax({
                                                 ...
                                                 type:'post',
                                                  dataType:'json',
                                                 data:{arr:deList.toString(),object:"courseInfo"},
            ...
            layer.open(
                {
                    ...
                    area: ['380px','485px'],
                    resize:true,
                    content: "/user/edit/EditCourseInfo",//跳转的页面
