    ...
    var
        ...
        infoOptions = {
            ...
            cols: [[
                ...
                {field: 'selid', title: 'ID', type:'radio', width:'10%', sort: true, fixed: 'left'}
                ,{field: 'selname', title: '名称', width:'10%',edit:'text'}
                ,{field: 'selgrade', title: '年级', width:'10%'}
                ,{field: 'selnum', title: '人数', width:'10%',edit:'text'}
                ,{field: 'synum', title: '剩余人数', width:'10%'}
                ,{field: 'starttime', title: '开始时间', width:'15%'}
                ,{field: 'endtime', title: '结束时间', width:'15%'}
                ,{field: 'courseclass', title: '上课地点', width:'10%'}
                ,{fixed: 'right',title: '操作', width:'10%', align:'center', toolbar: '#barDemo', hide : ishide}
            ]],
            data: [],
            loading:true
        };
    ...
    var active = {
                         ...
                         if(deList!=''){
                                  layer.confirm('确定删除所选项吗？',function (index) {
                                          $.ajax({
                                                 ...
                                                 type:'post',
                                                  dataType:'json',
                                                 data:{arr:deList.toString(),object:"seleteCourse"},
            ...
            layer.open(
                {
                    ...
                    area: ['380px','485px'],
                    resize:true,
                    content: "/user/edit/EditSelectCourse",//跳转的页面
        ...
        select:function(){
            ...
            if(data!=null&&data.length>0){
                ...
                layer.tips('请选择需要选课的行',$('#filterData'),{
                    tips:[3,'#5fb878']
                })
            }
        }
