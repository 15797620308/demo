    ...
    var
        ...
        infoOptions = {
            ...
            cols: [[
                ...
                {field: 'scoreid', title: 'ID', type:'checkbox', width:'10%', sort: true, fixed: 'left'}
                         ...
                         if(deList!=''){
                                  layer.confirm('确定删除所选项吗？',function (index) {
                                          $.ajax({
                                                 ...
                                                 type:'post',
                                                  dataType:'json',
                                                 data:{arr:deList.toString(),object:"studentScore"},
            ...
            layer.open(
                {
                    ...
                    area: ['380px','485px'],
                    resize:true,
                    content: "/user/edit/EditStudentScore",//跳转的页面
    ...
    table.on('tool(test)', function(obj){
        ...
        } else//删除数据
        {
            layer.confirm('真的删除行么', function(index){
                $.post("/user/deldata",{id:data.scoreid,object:"studentScore" },
                function(msg){
                    if(msg.code==1){
