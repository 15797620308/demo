    ...
    var
        ...
        infoOptions = {
            ...
            cols: [[
                ...
                ,{field: 'stuname', title: '姓名', width:'10%',edit:'text'}
                ,{field: 'stusex', title: '性别', width:'10%'}
                ,{field: 'stubrith', title: '出生年月', width:'10%',edit:'text'}
                ,{field: 'stufamily', title: '家庭成员', width:'15%'}
                ,{field: 'stuaddress', title: '家庭住址', width:'10%'}
                ,{field: 'stunation', title: '民族', width:'15%'}
                         ...
                         if(deList!=''){
                                  layer.confirm('确定删除所选项吗？',function (index) {
                                          $.ajax({
                                                 ...
                                                 type:'post',
                                                  dataType:'json',
                                                 data:{arr:deList.toString(),object:"studentBase"},
            ...
            layer.open(
                {
                    ...
                    area: ['380px','485px'],
                    resize:true,
                    content: "/user/edit/EditStudentBase",//跳转的页面
    ...
    table.on('tool(test)', function(obj){
        ...
        } else//删除数据
        {
            layer.confirm('真的删除行么', function(index){
                $.post("/user/deldata",{id:data.stuid,object:"studentBase" },
                function(msg){
                    if(msg.code==1){
